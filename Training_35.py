...
writer = SummaryWriter(comment="500_35")
...
for epoch in range(num_epochs):
  ...
  for i, (parameters, no_req) in enumerate(train_loader):
    ...
    outputs = model(input_x[:,:,0:28], array_lengths)
  ...
  if (epoch%1 == 0):
    ...
    os.makedirs('./Model_35', exist_ok=True)
    torch.save(model, f'./Model_35/epoch_{epoch+1}.pth') ##FIXME
